...
//	establecer la posición de la luz
		GLfloat param[]={posicion[0],posicion[1],posicion[2],1};
		glLightfv(idLuz,GL_POSITION,param);
//	establecer los colores ambiental, difuso y especular
		GLfloat luzambiental[]={colorAmbiente[0],colorAmbiente[1],colorAmbiente[2],colorAmbiente[3]};
		glLightfv(idLuz,GL_AMBIENT,luzambiental);
		GLfloat luzdifusa[]={colorDifuso[0],colorDifuso[1],colorDifuso[2],colorDifuso[3]};
		glLightfv(idLuz,GL_DIFFUSE,luzdifusa);
		GLfloat luzespecular[]={colorEspecular[0],colorEspecular[1],colorEspecular[2],colorEspecular[3]};
		glLightfv(idLuz,GL_SPECULAR,luzespecular);
...
//	establecer la atenuación angular y la dirección del foco
		GLfloat dirfoco[]={direccion_foco[0],direccion_foco[1],direccion_foco[2]};
